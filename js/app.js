...
import { setPage, setOnPageChange } from './router.js?v=3';
import { renderHistory, renderServices, setPeriod, shiftPeriod } from './render.js?v=3';
import {
...
import { copyPhone, callPhone } from './utils.js?v=3';
